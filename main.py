...
def main():
    ...
    system_prompt = rd.get("angela@appswithoutcode.com-systemprompt-01").decode('utf-8')
    initial_text = rd.get("angela@appswithoutcode.com-initialtext-01").decode('utf-8')
